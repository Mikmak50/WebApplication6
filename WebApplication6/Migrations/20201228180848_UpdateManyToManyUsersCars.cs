...
{
    public partial class UpdateManyToManyUsersCars : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlaceStartId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlaceEndId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rides_Places_PlaceEndId",
                        column: x => x.PlaceEndId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rides_Places_PlaceStartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rides_PlaceEndId",
                table: "Rides",
                column: "PlaceEndId");

            migrationBuilder.CreateIndex(
                name: "IX_Rides_PlaceStartId",
                table: "Rides",
                column: "PlaceStartId");
